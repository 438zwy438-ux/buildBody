...
public class TbEquipmentController {
     ...
     *
     * @param page 分页对象
     * @param tbEquipment 查询实体
     * @return 所有数据
     */
    @Operation(summary = "分页查询所有数据")
    @GetMapping("/selectAll")
    public Result<Page<TbEquipment>> selectAll(Page<TbEquipment> page, TbEquipment tbEquipment) {
        return Result.success(this.tbEquipmentService.page(page, new QueryWrapper<>(tbEquipment)));
    }
     ...
     * 新增数据
     *
     * @param tbEquipment 实体对象
     * @return 新增结果
     */
    @Operation(summary = "新增数据")
    @PostMapping("/insert")
    public Result<Boolean> insert(@RequestBody TbEquipment tbEquipment) {
        return Result.success(this.tbEquipmentService.save(tbEquipment));
    }
