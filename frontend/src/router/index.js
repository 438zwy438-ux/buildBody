  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'equipment',
        name: 'EquipmentList',
        component: () => import('@/views/user/EquipmentList.vue'),
        meta: { title: '健身器材', requiresAuth: false }
      },
      {
        path: 'equipment/:id',
      ...
      },
      {
        ...
        meta: { title: '我的会员卡', requiresAuth: true, requiredRoles: ['user', 'vip'] }
      },
      {
        path: 'courses',
        name: 'UserCourses',
        component: () => import('@/views/user/Courses.vue'),
        meta: { title: '我的课程', requiresAuth: true, requiredRoles: ['user', 'vip'] }
      },
      {
        path: 'course-booking',
      ...
      },
      {
        ...
        meta: { title: '入场记录', requiresAuth: true, requiredRoles: ['user', 'vip'] }
      },
      {
        path: 'orders',
        name: 'UserOrders',
